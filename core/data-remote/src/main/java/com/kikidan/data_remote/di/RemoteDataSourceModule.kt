...
import com.kikidan.data_remote.datasource.RemoteCompatibilityDataSourceImpl
...
abstract class RemoteDataSourceModule {
    ...
    @Binds
    @Singleton
    abstract fun bindCompatibilityRemoteDataSource(
        impl: RemoteCompatibilityDataSourceImpl,
